            ...
            <div className="joblistbgdiv">
                <div className="click_instruction_div">
                    ...
                    <div style={{float:"right",marginTop:-60}}>
                        <p style={{display:"inline",position:"absolute",left:1000}}>Sort by</p>
                        <div style={{display:"inline",position:"absolute",left:1100}}>
                            <Select options={sortOptions} openMenuOnFocus styles={dropDownStyle} isClearable  placeholder='None...' />
                        </div>
                        <div style={{display:"inline",position:"absolute",left:1350}}>
                           <button onClick={() => this.toggleSort()}>
                              {this.state.asc ? <HiSortAscending/> : <HiSortDescending/>}
                            </button>
                        </div>
                    </div>
