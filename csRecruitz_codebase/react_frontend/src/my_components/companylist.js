        ...
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">Employer Name</StyledTableCell>
              ...
              <StyledTableCell align="right">Organization type</StyledTableCell>
          ...
          {this.state.items.map((row) => (
            <StyledTableRow key={row.application_id} name={row.jobshortlist_id}>
              <StyledTableCell component="th" scope="row">{row.name} </StyledTableCell>
                <StyledTableCell align="right">{row.district}, {row.division}</StyledTableCell>
                <StyledTableCell align="right">{row.org_type}</StyledTableCell>
                <StyledTableCell align="right"><button className="btn btn-sm btn-success" id={row.user_ptr_id} >View</button></StyledTableCell>
